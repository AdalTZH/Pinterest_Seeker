...
Your task: Analyze the provided product image and craft a single, detailed image generation prompt that will produce a breathtaking e-commerce poster for the brand "PromSpark".
...
5. **Style**: Specify photographic style (editorial, luxury campaign, fashion photography, fine art)
...
- The poster should feel like a luxury brand campaign — minimal text, maximum visual impact
